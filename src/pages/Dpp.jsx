        ...
        <div className="flex flex-col items-center justify-center mt-32 px-4">
          ...
          >
            <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl p-6 border border-green-600 hover:border-green-400 transition-all duration-300">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Physics DPPs</h3>
              <p className="text-gray-300 text-sm">Daily practice problems covering all physics concepts with detailed solutions</p>
            </div>
            ...
            <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl p-6 border border-blue-600 hover:border-blue-400 transition-all duration-300">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Chemistry DPPs</h3>
              <p className="text-gray-300 text-sm">Comprehensive chemistry problems for organic, inorganic and physical chemistry</p>
            </div>
            ...
            <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl p-6 border border-white hover:border-gray-300 transition-all duration-300">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Maths DPPs</h3>
              <p className="text-gray-300 text-sm">Mathematical problems covering algebra, calculus, geometry and more</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Expert Faculty</h4>
                  <p className="text-gray-400 text-sm">Curated by experienced faculty with deep subject knowledge</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Latest Syllabus</h4>
                  <p className="text-gray-400 text-sm">Updated according to current JEE syllabus and exam patterns</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Exam Trends</h4>
                  <p className="text-gray-400 text-sm">Based on latest exam trends and question patterns</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Daily Practice</h4>
                  <p className="text-gray-400 text-sm">Consistent daily problems to build strong foundation</p>
                </div>
              </div>
            </div>
          </motion.div>
